...
def main():
    ...
    parser.add_argument("--cam_GUI", action="store_true", default=False, help="Enable camera GUI")
    parser.add_argument("--cam_control", action="store_true", default=False, help="Enable keyboard camera control")
    ...
    camera_pos = np.array([0.0, 0.0, 2.0])  # Initial camera position
    camera_lookat = np.array([0.0, 0.0, 0.3])  # Initial lookat position
    camera_step = 0.05  # Movement step size
    
    if args.cam_control:
        print("\n" + "="*60)
        print("CAMERA CONTROL ENABLED")
        print("="*60)
        print("Camera Position Controls:")
        print("  W/S: Move camera forward/backward (Z axis)")
        print("  A/D: Move camera left/right (X axis)")
        print("  Q/E: Move camera up/down (Y axis)")
        print("\nCamera Lookat Controls:")
        print("  I/K: Move lookat forward/backward (Z axis)")
        print("  J/L: Move lookat left/right (X axis)")
        print("  U/O: Move lookat up/down (Y axis)")
        print("\nOther Controls:")
        print("  R: Reset camera to initial position")
        print("  P: Print current camera position and lookat")
