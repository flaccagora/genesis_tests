...
from train.train_encoder import MeshAutoencoderLightningModule, MeshDataModule
...
def run(config: Dict[str, Any]) -> None:
    ...
    lightning_module = MeshAutoencoderLightningModule(
...
if __name__ == "__main__":
    ...
    # Data
    train_dir = "datasets/meshes/train"
