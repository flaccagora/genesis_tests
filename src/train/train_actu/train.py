...
from train.train_actu.datamodule import ActuationRotationDataModule
...
def run(config: Dict[str, Any]) -> None:
    data_module = ActuationRotationDataModule(
...
if __name__ == "__main__":
    ...
    # Model
    model_cls = "RGB_ActuationRotationPredictor"  # Options: "NN", "DeformNet", "RGB_ActuationRotationPredictor"
